                                    ...
                                    <table class="table table-bordered mb-0" style="font-size:12px">
                                        ...
                                        <tbody>
                                            <?php foreach ($emp as $key ) {?>
                                                ...
                                                <td><a href="{{route('view_employee_details',['addedsecond'=>$key->addedsecond])}}"><button  class="btn btn-primary">open</button> </a></td>
                                            </tr>
                                            <?php   } ?>
